...
const TRANSLATIONS = {
  fr: {
    ...
    features: [
      ...
      { icon: '🔗', title: 'Partagez', desc: 'Partagez votre classeur via un lien unique. Vos amis peuvent consulter votre collection sans créer de compte.' },
      { icon: '✏️', title: 'Annotez', desc: "Notez l'état, le type (foil, holo), le prix de vente et des remarques pour chaque carte de votre collection." },
      { icon: '🃏', title: 'Multi-jeux', desc: 'Pokémon, Magic: The Gathering, Dragon Ball Super, Star Wars Unlimited, Final Fantasy TCG, One Piece — tout au même endroit.' },
    ],
  ...
  en: {
    ...
    features: [
      ...
      { icon: '🔗', title: 'Share', desc: 'Share your binder with a unique link. Anyone can browse your collection without signing up.' },
      { icon: '✏️', title: 'Annotate', desc: 'Track condition, finish (foil, holo), selling price and personal notes for each card in your collection.' },
      { icon: '🃏', title: 'Multi-game', desc: 'Pokémon, Magic: The Gathering, Dragon Ball Super, Star Wars Unlimited, Final Fantasy TCG, One Piece — all in one place.' },
    ],
